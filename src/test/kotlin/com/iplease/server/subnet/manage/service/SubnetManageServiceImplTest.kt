...
class SubnetManageServiceImplTest {
    ...
    lateinit var table: SubnetTable
    ...
    fun setUp() {
        ...
        second = (0..255).random()
        third = (0..255).random()
        table = SubnetTable(uuid, issuerUuid, first, second, third)
    }
    ...
    fun addSubnetSuccess() {
        ...
        val result = subnetManageService
            .add(issuerUuid, Subnet(first, second, third))
            .block()!!
        ...
        assert(result.subnet == Subnet(first, second, third))
    }
    ...
    fun addSubnetFailureExist() {
        ...
        assert(exception.subnet == Subnet(first, second, third))
